    ...
    return Row(
      children: [
        ...
        Expanded(
          flex: 11,
          child: SizedBox(
            width: EcommerceDeviceUtils.getScreenWidth(context) * 0.8,
            child: LinearProgressIndicator(
              value: value,
              minHeight: 11,
              backgroundColor: EcommerceColors.grey,
              borderRadius: BorderRadius.circular(7),
              valueColor: const AlwaysStoppedAnimation(EcommerceColors.primary),
            ),
          ),
        )
      ],
